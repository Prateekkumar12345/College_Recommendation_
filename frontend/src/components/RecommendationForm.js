...
const RecommendationForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setActiveTab("results"); // Switch to results tab after getting recommendations
    } catch (err) {
  ...
  const handleVisualize = async (studentData) => {
    return await getVisualizations(studentData);
  };
  ...
  return (
    <div className="recommendation-form">
      ...
      <div className="main-tabs">
        <button
          className={activeTab === "form" ? "main-tab-active" : "main-tab"}
          onClick={() => setActiveTab("form")}
        >
          Student Profile
        </button>
        <button
          className={activeTab === "results" ? "main-tab-active" : "main-tab"}
        ...
        <button
          className={
            activeTab === "visualizations" ? "main-tab-active" : "main-tab"
          }
        ...
        <div className="results-section">
          ...
          {recommendations.length === 0 && !loading && (
            <div className="no-recommendations">
              <p>
                No recommendations yet. Please fill out the form and get
